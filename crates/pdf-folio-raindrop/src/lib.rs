...
async fn resolve_access_token(oauth_config: Option<RaindropOAuthConfig>) -> Result<String> {
...
fn bundled_or_env_oauth_config() -> Option<RaindropOAuthConfig> {
...
fn cached_access_token() -> Result<String> {
