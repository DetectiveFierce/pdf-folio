//! # Built-in SVG icons
//!
//! Raw SVG byte constants for chevrons, undo/redo, layout toggles, and trash.
//! Consumed by iced `svg::Handle` helpers across library and shell chrome.

/// CHEVRON LEFT SVG constant.
